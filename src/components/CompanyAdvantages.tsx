...
const AdvantageItem = ({ icon, title, description }: AdvantageItemProps) => {
  return (
    <div className="flex flex-col items-center text-center p-4">
      <div className="text-[#2E8B57] mb-4">
        {icon}
      </div>
      <h3 className="font-bold text-main-gray text-lg mb-2">{title}</h3>
  ...
  return (
    <section className="w-full py-12 bg-gray-50">
      <div className="page-container">
        <h2 className="text-3xl font-bold text-main-gray mb-10 text-center">Наши преимущества</h2>
